<template>
  <div id="app">
    <div class="imui-center">
      ...
      <div class="action">
        <lemon-button @click="logout">退出登录</lemon-button>
...
export default {
  ...
  methods: {
    ...
    COMMAND_GET_USER_RESP(data) {
      ...
      this.user.displayName = user.nick;
    ...
    initSocket() {
      ...
      if (this.$store.getters.token == undefined) {
        ...
        this.socket = new WebSocket("ws:"+setting.sockerUrl+"?token="+this.$store.getters.token);
      }
